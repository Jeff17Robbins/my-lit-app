...
export class ProfileComponent extends LitElement {
    @property({ type: Boolean }) popoverVisible = false;
  ...
  `;
    ...
    render() {
        ...
        <button class="profile-button" @click=${this.togglePopover}>
          ${this.signedIn ? (this.avatarUrl ? html`<img class="avatar" src=${this.avatarUrl} alt="Profile Avatar">` : "Profile") : "Sign In"}
        </button>
